...
from .views import create_payment, confirm_payment, cancel_payment_patient, get_payment_details, invoice_pdf_view, create_payment_setup, update_payment_method, charge_payment, process_due_payments_api, get_physio_invoices, cancel_payment_pyshio, get_refund_status, collect_payments
urlpatterns = [
    #pagos
