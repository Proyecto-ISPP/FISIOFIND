...
from .views import create_or_update_rating, get_appointment_rating, get_my_rating, list_ratings, create_rating_by_room_code, report_rating, check_rating_by_room_code
...
urlpatterns = [
    ...
    path('report/<int:rating_id>/', report_rating, name='report_rating'),
