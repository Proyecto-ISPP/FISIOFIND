  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-xl shadow p-6 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="p-4 border rounded-lg relative">
            ...
            {payments.paid_payments.length > 0 && payments.redeemed_payments.length === 0 && (
              <button
      ...
      <div className="bg-white rounded-xl shadow p-6 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <div className="h-64">
              <p>(Gráfico de líneas: ingresos por mes)</p>
            </div>
          </div>
          <div>
      ...
      <div className="bg-white rounded-xl shadow p-6">
        ...
        <div className="mb-6">
          <h3 className="text-lg font-medium mb-2">No Pagados (Esperados)</h3>
        ...
        <div className="mb-6">
          <h3 className="text-lg font-medium mb-2">Pagados (Pendientes de Reclamar)</h3>
        ...
        <div>
          <h3 className="text-lg font-medium mb-2">Cobrados</h3>
