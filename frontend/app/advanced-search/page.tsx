              ...
              {results.length === 0 && suggested.length === 0 ? (
                ...
                <>
                  ...
                  <div className="relative overflow-hidden rounded-2xl bg-white shadow-lg p-4 border border-gray-100">
                    ...
                    >
                      <div
                        className="flex transition-transform duration-500 ease-[cubic-bezier(0.2, 0.1, 0.2, 1)] gap-40 px-18"
                        style={{
                        ...
                        <AnimatePresence>
                          {displayResults.map((physio, i) => (
                            <motion.div
                                ...
                                className={`flex-shrink-0 p-6 ${displayResults.length === 1 ? "mx-auto" : ""}`}
                                style={{
                                  minWidth: `${80 / cardsPerPage}%`,  // Reduced from 100% to 80% to make cards smaller
                                  maxWidth: `${80 / cardsPerPage}%`,  // Reduced from 100% to 80% to make cards smaller
                                }}
                              >
