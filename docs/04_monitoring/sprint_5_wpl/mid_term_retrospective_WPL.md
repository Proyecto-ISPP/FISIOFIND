...
<h1 align="center" style="font-size: 30px; font-weight: bold;">
  FISIO FIND  -  MID TERM RETROSPECTIVE #WPL
</h1>
...
|------------|---------|----------------------------------|----------------------------|
| 15/05/2025 | v1.0    | Daniel Alors Romero,  Francisco Mateos Villarejo, Miguel Encina Martínez, Benjamín Ignacio Maureira Flores  | Elaboración de la primera versión del documento |
...
- **Horas realizadas:** 173 h 18 min
- **Causa principal:** Sobreesfuerzo de algunos miembros del equipo en tareas de marketing.
- **Impacto:** X
- **Medidas futuras:** X

![Reloj de avance del proyecto](../../.img/reloj_de_avance_proyecto_15-05-2025.png)
