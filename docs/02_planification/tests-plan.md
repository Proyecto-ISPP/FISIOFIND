...
A fecha de redacción de este documento, Fisio Find tiene los siguientes módulos en el backend:
- appointment
- appointment_rating
- files
- guest_session
...
De estos módulos, faltan por probar:
- appointment_rating
- files
- payment
...
|appointment/emailUtils.py                        | 116    | 75   | 35%|
...
|appointment_rating/models.py                     |  16    |  1   | 94%|
|appointment_rating/serializers.py                |  19    |  6   | 68%|
|appointment_rating/tests.py                      |   1    |  0   |100%|
|appointment_rating/urls.py                        |  3     | 0   |100%|
|appointment_rating/views.py                       |127     |89   | 30%|
...
|files/models.py                                   | 42     |17   | 60%|
|files/serializers.py                              | 93     |65   | 30%|
|files/tests.py                                    |  1     | 0   |100%|
|files/urls.py                                     |  3     | 0   |100%|
|files/views.py                                    |204    1|61   | 21%|
|fisio_find/__init__.py                            |  0     | 0   |100%|
|fisio_find/settings.py                            | 77     | 7   | 91%|
|fisio_find/urls.py                                | 14     | 3   | 79%|
|gestion_survey/__init__.py                        |  0     | 0   |100%|
|gestion_survey/admin.py                           |  3     | 0   |100%|
|gestion_survey/migrations/0001_initial.py         |  5     | 0   |100%|
|gestion_survey/migrations/__init__.py             |  0     | 0   |100%|
|gestion_survey/models.py                          |  5     | 0   |100%|
...
|guest_session/views.py                            |205     |39   | 81%|
|manage.py                                         | 11     | 2   | 82%|
...
|payment/models.py                                 | 23    |  2   | 91%|
|payment/serializers.py                            |  9    |  0   |100%|
|payment/tests.py                                  |  1    |  0   |100%|
|payment/urls.py                                   |  3    |  0   |100%|
|payment/utils/pdf_generator.py                    | 95    | 79   | 17%|
|payment/views.py                                  |402    |330   | 18%|
...
|terms/tests.py                                    |108     6|8   | 37%|
|terms/urls.py                                     |  3      |0   |100%|
|terms/views.py                                   |  72    | 38   | 47%|
...
|treatments/models.py                             | 116    | 15   | 87%|
|treatments/serializers.py                        | 104    |  8   | 92%|
|treatments/tests.py                              |1199    |278   | 77%|
|treatments/urls.py                               |   3    |  0   |100%|
|treatments/views.py                              | 628    |356   | 43%|
|users/__init__.py                                |   0    |  0   |100%|
|users/admin.py                                   |  48    |  2   | 96%|
|users/apps.py                                    |   4    |  0   |100%|
|users/emailUtils.py                              |  88    | 59   | 33%|
|users/forms.py                                   | 101    | 76   | 25%|
|users/migrations/0001_initial.py                 |  12    |  0   |100%|
|users/migrations/__init__.py                     |   0    |  0   |100%|
|users/models.py                                  | 123    | 13   | 89%|
|users/permissions.py                             |  13    |  1   | 92%|
|users/serializers.py                             | 325    | 76   | 77%|
|users/subscription_views.py                      |  53    | 37   | 30%|
|users/tests.py                                   |1305    | 42   | 97%|
|users/urls.py                                    |   7    |  0   |100%|
|users/util.py                                    | 132    |  8   | 94%|
|users/validacionFisios.py                        | 395    |374   |  5%|
|users/views.py                                   | 387    |137   | 65%|
...
En resumen, el coverage total actual es del 73%. Como se puede ver, hay módulos que ya están probados pero podría mejorarse su coverage.

## 4.2 PRUEBAS DE INTERFAZ
En cuanto a las pruebas de interfaz, actualmente no están implementadas
...
- Pruebas de integración o unitarias para todos los módulos del backend de Fisio Find.
  - Estas pruebas deberán de ofrecer un coverage mínimo del 80%.
